...
class RunRateCalculator:
    ...
    def _calculate_all_metrics(self) -> dict:
        ...
        total_shots, stop_events = len(df), df["stop_event"].sum()
...
if df_view.empty:
    ...
    if analysis_level == "Daily":
        ...
        # [Daily rendering logic remains here]
        ...
        with st.expander(f"View {trend_level} Breakdown Table", expanded=False):
             st.dataframe(summary_df) # Simplified for brevity

        # [Trend charts for Weekly/Monthly would follow]
