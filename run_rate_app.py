...
if df_view.empty:
    ...
    if st.session_state.show_llm_analysis:
        ...
        <div style="border: 1px solid #262730; border-radius: 0.5rem; padding: 1rem; margin-top: 1rem; font-family: sans-serif;">
            <h4>🤖 AI-Generated Analysis (Static Demo)</h4>
            <p>This is a static demonstration. In a live environment with a configured API key, this text would be dynamically generated by an AI model based on the data below.</p>
            <ul>
        ...
        """
        components.html(static_analysis, height=220, scrolling=True)
